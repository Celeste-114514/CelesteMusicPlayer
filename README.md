...
- 🔌 流媒体插件服务（可选 WSL 侧，`streaming-plugin/`）：Apple Music / 网易云 / QQ 搜索、歌词、下载 API
...
- ⬇️ **音频下载增强**：下载时把播放器内对应平台 Cookie 传给服务（用于需鉴权直链）；网易云 / QQ 下载 128k MP3，Apple Music 说明不提供音频下载（仅搜索 / 歌词 / 标签）；在线搜索窗口增加封面色图、详情加"下载音频"按钮
- 🎤 Apple Music 歌词优先走插件服务取真歌词（失败回退现有在线源）
